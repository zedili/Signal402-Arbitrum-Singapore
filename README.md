...
[`docs/source-provenance.md`](docs/source-provenance.md). Qualifying in-window
work will be recorded here from September 14, 2026 onward.
...
The current Arbitrum Open House Singapore entry is led by one founder and
full-stack builder (`zedili` / `zdl`), supported by AI development agents.
...
- [Pre-event Git baseline](docs/pre-event-baseline.md)
- [HackQuest final submission field map](docs/submission-field-map.md)
- [Prize-track decision brief](docs/prize-track-decision.md)
